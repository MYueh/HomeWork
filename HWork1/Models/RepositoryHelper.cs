namespace HWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static V_CUSLISTRepository GetV_CUSLISTRepository()
		{
			var repository = new V_CUSLISTRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static V_CUSLISTRepository GetV_CUSLISTRepository(IUnitOfWork unitOfWork)
		{
			var repository = new V_CUSLISTRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
